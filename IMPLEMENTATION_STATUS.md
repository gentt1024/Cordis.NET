...
Cordis.NET `0.1.0-alpha.1` implements the pinned runtime and composition scope as an early preview. The public status is maintained in [compatibility](docs/compatibility.md), [validation](docs/validation.md), and the machine-readable maps under `docs/`.
